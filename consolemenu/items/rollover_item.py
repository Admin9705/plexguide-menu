...
class RolloverItem(ExternalItem):
    """
    A menu item to execute a console command
    """

    def __init__(self, text, command, arguments=None, menu=None, should_exit=True):
        """
        ...
        """
        super(RolloverItem, self).__init__(text=text, menu=menu, should_exit=should_exit)
